...
And I get Activemq endpoint tcp://64.227.37.97:61616 and queue name testAutomation and actual outputFile location G:\NJC_work\projects\Automation_personal\apiops-anypoint-bdd-sapi\cucumber-API-Framework\src\DqueueDatafile path with extention json
