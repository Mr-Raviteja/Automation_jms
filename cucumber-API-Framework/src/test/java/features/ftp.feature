...
Given I get the expected outputFile from the location G:\NJC_work\projects\Automation_personal\apiops-anypoint-bdd-sapi\cucumber-API-Framework\src\expectedOutFile path with extention json
